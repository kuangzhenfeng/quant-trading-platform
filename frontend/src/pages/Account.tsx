  ...
  return (
    <>
      <style>{`
        ...
        [data-theme="light"] .account-card::before {
        ...
        [data-theme="light"] .account-table .ant-table-thead > tr > th {
          background: rgba(245, 158, 11, 0.04) !important;
        }
        .account-table .ant-table-tbody > tr:hover > td {
          background: rgba(34, 211, 238, 0.03) !important;
        }
        [data-theme="light"] .account-table .ant-table-tbody > tr:hover > td {
          background: rgba(245, 158, 11, 0.03) !important;
        }
        .account-table .ant-table-tbody > tr:nth-child(even) > td {
          background: transparent;
        }
        [data-theme="light"] .account-table .ant-table-tbody > tr:nth-child(even) > td {
          background: rgba(0, 0, 0, 0.015);
        }
        .account-table .ant-table-tbody > tr:nth-child(even):hover > td {
          background: rgba(245, 158, 11, 0.03) !important;
        }
        [data-theme="light"] .broker-tag {
          color: var(--amber-500) !important;
          background: color-mix(in srgb, var(--amber-500) 10%, transparent) !important;
          border-color: color-mix(in srgb, var(--amber-500) 25%, transparent) !important;
        }
        ...
        [data-theme="light"] .account-delete-btn:hover {
          background: rgba(220, 38, 38, 0.12) !important;
          border-color: rgba(220, 38, 38, 0.35) !important;
        }
        [data-theme="light"] .add-account-btn {
      ...
      <div className="page-content" style={{ padding: '32px 32px 48px', minHeight: '100vh', background: 'var(--bg-base)' }}>
        ...
        {/* Table Card */}
        <div
          className="account-card animate-in stagger-2"
          style={{
